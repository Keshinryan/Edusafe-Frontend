            ...
            <div class="card-body">
              <form @submit.prevent="store">
                <div class="form-group">
                  ...
                  <input type="text" name="name_m" class="form-control" v-model="mahasiswa.name"
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="password" class="form-control" v-model="mahasiswa.password"
...
<<<<<<< HEAD
    // Function to store the mahasiswa data to the API
    function store() {
