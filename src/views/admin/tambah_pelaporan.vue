            ...
            <div class="card-body">
              <form @submit.prevent="store">
                <div class="form-group">
                  ...
                  <input type="date" name="tanggal" class="form-control" v-model="pelaporan.tanggal"
                ...
                <div class="form-group">
                  ...
                  <input type="time" name="waktu" class="form-control" v-model="pelaporan.waktu"
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tempat" class="form-control" v-model="pelaporan.tempat"
                    placeholder="Tempat Kejadian" />
                  <div v-if="validation.tempat" class="mt-2 alert alert-danger">
                    {{ validation[0] }}
                  </div>
                </div>
                <div class="form-group">
                  <label for="deskripsi">Deskripsi Kejadian</label>
                  <input type="text" name="deskripsi" class="form-control" v-model="pelaporan.deskripsi"
                ...
                <div class="form-group">
                  ...
                  <input type="file" name="bukti" class="form-control" placeholder="Bukti Kejadian" />
                  <div v-if="validation.bukti" class="mt-2 alert alert-danger">
                    {{ validation[0] }}
                  </div>
                </div>
...
<<<<<<< HEAD
    // Function to store the pelaporan data to the API
=======
